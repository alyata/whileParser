...
% Most of the required packages are standard and should be provided by most TeX 
% installations
% The exception is mathpartir, which may be downloaded from Piazza or 
% http://cristal.inria.fr/~remy/latex/

% This template is also available to use as a template on the following online 
% LaTeX editors:
%   Overleaf   - https://www.overleaf.com/latex/templates/models-of-computation-assessed-coursework-template/yxyxxwxcrgst
%   ShareLaTeX - https://www.sharelatex.com/templates/545ba249f017c8831bbb4f80
